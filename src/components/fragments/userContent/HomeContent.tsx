          ...
          <div className="row">
            ...
            <div className="col-12 col-md-6 our-services-text-container">
              ...
              <ul className="custom-list text-l-14">
                <p data-aos="fade-up">
                  <i data-feather="check" className="check-icon"></i>Sewa Mobil
                ...
                <p data-aos="fade-up">
                  <i data-feather="check" className="check-icon"></i>Gratis
                  Antar - Jemput Mobil di Bandara
                </p>
                <p data-aos="fade-up">
                  <i data-feather="check" className="check-icon"></i>Layanan
            ...
            <div className="col-md-3">
              <div className="card" data-aos="flip-left">
                <div className="card-body mx-2 mt-2">
                  <p>
                    <img
                      src="/assets/images/thumbs_up-icon.png"
            ...
            <div className="col-md-3">
              <div className="card" data-aos="flip-left">
                <div className="card-body mx-2 mt-2">
                  <p>
                    <img
                      src="/assets/images/award-icon.png"
      ...
      <section id="banner" className="mx-14">
        <div className="container-fluid px-5">
          <div className="row justify-content-center">
            <p className="text-b-36 text-center mb-0">
