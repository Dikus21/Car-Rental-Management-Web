              ...
              <div className="container-fluid">
                  <div className="row">
                      <div className="col-12 col-md-6 main-text-container">
                          ...
                          <Link to="/car">
                              <button type="button" className="btn btn-register text-b-14">Mulai Sewa Mobil</button>
                          </Link>
                      </div>
              ...
              <div className="container-fluid">
                  <div className="row">
                      <div className="col-12 col-md-6 our-services-img-container">
                          <img src='/assets/images/img_service.png' alt="" className="img-fluid our-services-img"/>
                      </div>
                      <div className="col-12 col-md-6 our-services-text-container">
                          <p className="text-b-24">Best Car Rental for any kind of trip in &#40;Lokasimu&#41;!</p>
                          ...
                          <ul className="custom-list text-l-14">
                              <p data-aos="fade-up"><i data-feather="check" className="check-icon"></i>Sewa Mobil Dengan
                                  Supir di Bali 12 Jam</p>
                              <p data-aos="fade-up"><i data-feather="check" className="check-icon"></i>Sewa Mobil Lepas
                                  Kunci di Bali 24 Jam</p>
                              <p data-aos="fade-up"><i data-feather="check" className="check-icon"></i>Sewa Mobil Jangka
                                  Panjang Bulanan</p>
                              <p data-aos="fade-up"><i data-feather="check" className="check-icon"></i>Gratis Antar -
                                  Jemput Mobil di Bandara</p>
                              <p data-aos="fade-up"><i data-feather="check" className="check-icon"></i>Layanan Airport
              ...
              <div className="container-fluid px-14 pb-5">
                  ...
                  <div className="row">
                      <div className="col-md-3">
                          <div className="card" data-aos="flip-left">
                              <div className="card-body mx-2 mt-2">
                                  <p><img src='/assets/images/thumbs_up-icon.png' className="thumbs-up-icon"/></p>
                                  <p className="text-b-16">Mobil Lengkap</p>
                                  <p className="text-l-14">Tersedia banyak pilihan mobil, kondisi masih baru, bersih dan
                                      terawat</p>
                              </div>
                          </div>
                      </div>
                      <div className="col-md-3">
                          <div className="card" data-aos="flip-left">
                              <div className="card-body mx-2 mt-2">
                                  <p><img src='/assets/images/tag-icon.png' className="tag-icon"/></p>
                                  <p className="text-b-16">Mobil Lengkap</p>
                                  <p className="text-l-14">Tersedia banyak pilihan mobil, kondisi masih baru, bersih dan
                                      terawat</p>
                              </div>
                      ...
                      <div className="col-md-3">
                          <div className="card" data-aos="flip-left">
                              <div className="card-body mx-2 mt-2">
                                  <p><img src='/assets/images/time-icon.png' className="time-icon"/></p>
                                  <p className="text-b-16">Mobil Lengkap</p>
                                  <p className="text-l-14">Tersedia banyak pilihan mobil, kondisi masih baru, bersih dan
                                      terawat</p>
                              </div>
                      ...
                      <div className="col-md-3">
                          <div className="card" data-aos="flip-left">
                              <div className="card-body mx-2 mt-2">
                                  <p><img src='/assets/images/award-icon.png' className="award-icon"/></p>
                                  <p className="text-b-16">Mobil Lengkap</p>
                                  <p className="text-l-14">Tersedia banyak pilihan mobil, kondisi masih baru, bersih dan
                                      terawat</p>
                              </div>
                              ...
                              <div className="item">
                                  <div className="row d-flex justify-content-center align-items-center">
                                      ...
                                      <div className="col-md-10 d-flex flex-column">
                                          <div className="star">
                                              {Array(5).fill(<span className="star">&#9733;</span>)}
                                          </div>
                                          <p className="text-l-14">“Lorem ipsum dolor sit amet, consectetur adipiscing elit,
          ...
          <section id="banner" className="mx-14">
              <div className="container-fluid px-5">
                  <div className="row justify-content-center">
                      ...
                      <button type="button" className="btn btn-register text-b-14 mt-4">Mulai Sewa Mobil</button>
                  </div>
              </div>
          </section>
                          ...
                          <div className="accordion">
                              <div className="accordion-item">
                                  <h2 className="accordion-header">
                                      <button className="accordion-button text-l-14" type="button"
                              ...
                              <div className="accordion-item">
                                  <h2 className="accordion-header">
                                      <button className="accordion-button collapsed text-l-14" type="button"
                                              data-bs-toggle="collapse"
